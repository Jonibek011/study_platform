...
function TeacherInfo() {
  ...
  return (
    <section className="teacher-info-container flex flex-col gap-2 md:gap-4 lg:gap-6 w-full h-full overflow-y-auto pe-2">
      ...
      <div className="teacher-lessons-section flex flex-col gap-2 md:gap-4 lg:gap-6">
        <h2 className="text-xl text-title font-bold">Darslari</h2>
